...
export default function NavbarRefactored() {
  ...
  const navbarBackground = scrolled ? "bg-white/95 backdrop-blur-md shadow-md" : "bg-transparent"
  ...
  const NavItem = ({ to, children, end = false }) => (
    <NavLink to={to} end={end} className="relative cursor-pointer" onClick={() => setOpen(false)}>
      {({ isActive }) => (
        <span
          className={cn(
            "relative font-semibold transition-colors",
            isActive ? "text-[#0067B0]" : cn(textColor, hoverColor),
          )}
        >
          {children}
          <span
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 font-sans">
      {/* TOP NAVBAR */}
      <div className={cn("transition-all duration-500 ease-in-out", navbarBackground)} style={{ height: "80px" }}>
        <div className="container mx-auto px-6 h-full flex items-center justify-between">
          {/* LOGO */}
          <NavLink
            to="/"
            className={cn("text-2xl font-bold transition-colors duration-300", logoColor)}
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger
                  className={cn(
                    ...
                    textColor,
                    "hover:text-[#0067B0] data-[state=open]:text-[#0067B0]",
                  )}
                >
                  Resources
                </NavigationMenuTrigger>
                    ...
                    <div className="relative z-10 space-y-3">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-white/70 text-sm">Expert insights, guides, and trending topics.</p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-white/70 text-sm">Real stories showing impact and results.</p>
                        </div>
                      </div>
                    </div>
                  </div>
       ...
       <NavLink
  to="/contact"
  className="px-6 py-2.5 rounded-lg font-bold text-white text-base hidden md:block transition-all hover:shadow-lg hover:scale-105"
...
>
  Get Started
          ...
          {/* MOBILE TOGGLE */}
          <button className={cn("md:hidden p-2 transition-colors", logoColor)} onClick={() => setOpen(!open)}>
